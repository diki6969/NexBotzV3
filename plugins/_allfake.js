...
handler.all = async function (m) {
  ...
  try {
    ...
    global.kontak2 = [
      [
        owner[0][0],
        await conn.getName(owner[0][0] + "@s.whatsapp.net"),
        "ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ",
        "gendonmenjeng@mail.com",
        true,
      ],
    ];
    ...
    global.fkontak = {
      ...
      message: {
        contactMessage: {
          ...
          thumbnail: "https://telegra.ph/file/1a49e56ab009e179f844b.jpg",
          sendEphemeral: true,
        },
      },
    };
        ...
        productMessage: {
          product: {
            productImage: {
              mimetype: "image/jpeg",
              jpegThumbnail:
                "https://telegra.ph/file/1a49e56ab009e179f844b.jpg", //Gambarnye
            },
